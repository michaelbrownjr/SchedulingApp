...
public class AppointmentDB {
    ...
    public static ObservableList<String> reportTotalsByTypeAndMonth() throws SQLException {
        ...
        // Prepare SQL
        PreparedStatement typeSqlCommand = DBConnection.getConnection().prepareStatement(
                "SELECT Type, COUNT(Type) as \"Total\" FROM appointments GROUP BY Type");

        PreparedStatement monthSqlCommand = DBConnection.getConnection().prepareStatement(
    ...
    public static Boolean updateAppointment(Integer inputApptID, String inputTitle, String inputDescription,
        ...
        PreparedStatement sqlCommand = DBConnection.getConnection().prepareStatement("UPDATE appointments "
    ...
    public static Boolean addAppointment(String inputTitle, String inputDescription,
        ...
        PreparedStatement sqlCommand = DBConnection.getConnection().prepareStatement("INSERT INTO appointments " +
    ...
    public static Boolean deleteAppointment(Integer inputApptID) throws SQLException {
        ...
        PreparedStatement sqlCommand = DBConnection.getConnection().prepareStatement("DELETE FROM appointments " +
    ...
    public static ObservableList<Appointment> getAllAppointments() throws SQLException {
        ...
        PreparedStatement sqlCommand = DBConnection.getConnection().prepareStatement("SELECT * FROM appointments as a\n" +
